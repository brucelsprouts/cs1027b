public class TestDataTypes {
	...
	public static void main(String[] args) {
		...
		System.out.println(data1.intVar == data2.intVar);

		// Test data1.charVar == data2.charVar
		System.out.println(data1.charVar == data2.charVar);

		// Test data1.boolVar == data2.boolVar
		System.out.println(data1.boolVar == data2.boolVar);

		// Test data1.doubleVar == data2.doubleVar
		System.out.println(data1.doubleVar == data2.doubleVar);

		// Test data1.varA == data2.varA
		System.out.println(data1.varA == data2.varA);

		// Test data1.varA.numItems == data2.varA.numItems
		System.out.println(data1.varA.numItems == data2.varA.numItems);
		
		// Test data1.varA.arrItems == data2.varA.arrItems		
		System.out.println(data1.varA.arrItems == data2.varA.arrItems);
	}
