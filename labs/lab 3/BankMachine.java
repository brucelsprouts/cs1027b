...
public class BankMachine {
    ...
    public static void main(String[] args) {
        ...
        if (accountType.equals("c")) {
            ...
            return; // If bad input, then end the program.
        }
        ...
        if (newAcc instanceof SavingsAccount) {
            System.out.println("Interest Rate: " + ((SavingsAccount) newAcc).getInterestRate());
        } else if (newAcc instanceof CheckingAccount) {
            ((CheckingAccount) newAcc).deductFees();
